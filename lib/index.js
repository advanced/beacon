...
function Beacon(options) {
    ...
    this.options.redis_port  = this.options.redis_port || 6379;
    this.options.redis_host = this.options.redis_host || 'localhost' ;
    ...
    this.redis = redis.createClient(this.options.redis_port,this.options.redis_host);
    this.pub = redis.createClient(this.options.redis_port,this.options.redis_host);
    this.sub = redis.createClient(this.options.redis_port,this.options.redis_host);
    this.initEvents();
}
